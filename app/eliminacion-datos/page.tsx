    ...
    <LegalPage eyebrow="Privacidad" title="Eliminación de datos" intro="Puedes solicitar la eliminación de tu cuenta y de los datos personales asociados a Ad Mavericks One.">
      <LegalSection title="Cómo enviar la solicitud">
        <ol className="list-decimal space-y-2 pl-5">
          <li>Escribe desde el correo registrado a <a className="font-bold text-forest underline" href={`mailto:${PRIVACY_EMAIL}?subject=Eliminación%20de%20datos%20-%20Ad%20Mavericks%20One`}>{PRIVACY_EMAIL}</a>.</li>
      ...
      <LegalSection title="Ayuda">
        <p>Si no puedes escribir desde el correo registrado, explica la situación a <a className="font-bold text-forest underline" href={`mailto:${PRIVACY_EMAIL}`}>{PRIVACY_EMAIL}</a>. Te indicaremos una alternativa razonable para verificar la solicitud.</p>
