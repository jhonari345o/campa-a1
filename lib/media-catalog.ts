...
export const DIGITAL_PLATFORMS: DigitalPlatform[] = [
  {
    slug: "google-ads", name: "Google Ads", status: "cotizable",
  ...
  {
    slug: "meta-ads", name: "Meta Ads", status: "cotizable",
    statusNote: "Inversión definida en el plan",
  ...
  {
    slug: "linkedin-ads", name: "LinkedIn Ads", status: "cotizable",
    statusNote: "Inversión definida en el plan",
  ...
  {
    slug: "tiktok-ads", name: "TikTok Ads", status: "cotizable",
    statusNote: "Inversión definida en el plan",
  ...
  {
    slug: "spotify-ads", name: "Spotify Ads", status: "cotizable",
    statusNote: "Inversión definida en el plan",
  ...
  {
    slug: "pinterest-ads", name: "Pinterest Ads", status: "cotizable",
    statusNote: "Inversión definida en el plan",
  ...
  {
    slug: "programmatic-dsp", name: "Programmatic · Ad Mavericks DSP", status: "cotizable",
    statusNote: "Inversión definida en el plan",
...
export const TV_CHANNELS: CatalogItem[] = [
  { slug: "ecuavisa", name: "Ecuavisa", status: "validacion", statusNote: "Referencia histórica · junio 2026", summary: "Programación informativa, entretenimiento y formatos de alcance masivo.", detail: "Cobertura comercial por confirmar en cada planificación.", incorporated: ["Parrilla Guayaquil/Quito", "Tarifario 30s histórico", "Ratings para planificación"], pending: ["Tarifario vigente", "Disponibilidad", "Negociación final", "Curva de reach/frecuencia"], count: 45 },
  { slug: "red-comercial", name: "Red Comercial", status: "cotizable", statusNote: "Cotizable · agosto 2026", summary: "Canal y grupo comercial para planes de televisión.", detail: "Programación, frecuencia e inversión se confirman en la cotización." },
  { slug: "teleamazonas", name: "Teleamazonas", status: "validacion", statusNote: "Tarifario julio 2026 · reconfirmar", summary: "Programación nacional, noticias y entretenimiento.", detail: "Tarifario, disponibilidad y negociación final por reconfirmar." },
  { slug: "tc-television", name: "TC Televisión", status: "cotizable", statusNote: "Cotizable · julio 2026", summary: "Televisión abierta con entretenimiento, noticias y formatos masivos.", detail: "Programación y condiciones comerciales sujetas a confirmación." },
  { slug: "oromar-tv", name: "Oromar TV", status: "directorio", statusNote: "Información comercial en carga", summary: "Canal de televisión abierta incorporado al directorio.", detail: "Tarifario, disponibilidad y cobertura comercial en carga." },
  { slug: "catomedia-ucsg", name: "Catomedia · UCSG TV", status: "cotizable", statusNote: "Julio 2026 · reconfirmar", summary: "Oferta televisiva y comercial de UCSG TV.", detail: "Vigencia, disponibilidad y condiciones por reconfirmar." },
  { slug: "ecuador-tv", name: "Ecuador TV", status: "directorio", statusNote: "Información comercial en carga", summary: "Canal público incorporado al directorio nacional.", detail: "Información comercial y disponibilidad en carga." },
];

export const OOH_PROVIDERS: CatalogItem[] = [
  { slug: "gran-comercio", name: "Gran Comercio", status: "validacion", statusNote: "En normalización", summary: "Proveedor de vía pública con catálogo detallado en proceso de normalización.", detail: "Presentación comercial recibida; ubicaciones, imágenes y disponibilidad en normalización." },
  { slug: "duoprint", name: "Duoprint", status: "cotizable", statusNote: "130 fichas incorporadas", summary: "Formatos digitales, tradicionales, centros comerciales, Aerovía y experiencias especiales.", detail: "Catálogo comercial 2026 normalizado; valores sin IVA y disponibilidad por reconfirmar.", coverage: "El Oro, Guayas, Imbabura, Manabí, Morona Santiago, Nacional, Pastaza, Pichincha, Santa Elena y Tungurahua", count: 130 },
  { slug: "zazapec", name: "Zazapec", status: "cotizable", statusNote: "180 fichas incorporadas", summary: "Inventario territorial de publicidad exterior.", detail: "Ubicaciones, imágenes, formatos y tarifas incorporadas; disponibilidad por reconfirmar.", count: 180 },
  { slug: "creamedios", name: "Creamedios", status: "directorio", statusNote: "En carga", summary: "Proveedor de publicidad exterior incorporado al directorio.", detail: "Inventario y condiciones comerciales en carga." },
  { slug: "induvallas", name: "Induvallas", status: "directorio", statusNote: "En carga", summary: "Proveedor de publicidad exterior incorporado al directorio.", detail: "Inventario y condiciones comerciales en carga." },
...
export const PRESS_OUTLETS: CatalogItem[] = [
  { slug: "el-universo", name: "El Universo", status: "validacion", statusNote: "Planificación editorial 2026 en validación", summary: "Noticias, actualidad y formatos editoriales impresos.", detail: "Nacional; tarifas publicables, edición y disponibilidad por confirmar." },
  { slug: "el-comercio", name: "El Comercio", status: "directorio", statusNote: "Ficha de directorio", summary: "Noticias, análisis y formatos editoriales impresos.", detail: "Tarifario, formatos, ediciones y disponibilidad pendientes." },
  { slug: "expreso", name: "Expreso", status: "directorio", statusNote: "Ficha de directorio", summary: "Actualidad y contenidos informativos impresos.", detail: "Tarifario, formatos, ediciones y disponibilidad pendientes." },
  { slug: "extra", name: "Extra", status: "directorio", statusNote: "Ficha de directorio", summary: "Noticias, entretenimiento y formatos editoriales de alta circulación.", detail: "Tarifario, formatos, ediciones y disponibilidad pendientes." },
  { slug: "metro-ecuador", name: "Metro Ecuador", status: "cotizable", statusNote: "Catálogo comercial 2026", summary: "Formatos impresos estándar, premium y especiales, content marketing, display, redes y Nueva Mujer.", detail: "73 formatos incorporados; ECU equivale a Quito + Guayaquil + Cuenca, no a cobertura nacional total.", count: 73 },
